...
| --- | --- | ---: | --- |
| Paper Source | `paper-source` | `2.9.0` | 发现、排序、获取、解析、审计、staging、approval、vault 图谱可见性初始化、Zotero helper adapter、发现期 Zotero dedupe 和 record-only 论文证据。 |
| Paper Wiki | `paper-wiki` | `1.3.0` | 面向正式论文 wiki 的问答、沉淀、检测、关系图谱可见性修复、更新、重 link、重做、Zotero helper adapter、Zotero 数据契约基础、只读 Zotero status/dry-run 预览、批准式 Zotero apply 同步和维护。 |
