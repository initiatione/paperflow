...
| 单篇证据层 | 这篇论文是否真的读懂了，公式/图/表有没有被保留下来 | acquire、MinerU、reader、critic、paper-gate | `_epi/raw/papers/<slug>/*`、`reader/evidence-map.json`、`critic/critic-report.json` |
...
<vault>/_epi/raw/papers/<slug>/acquire-record.json
<vault>/_epi/raw/papers/<slug>/parse-record.json
<vault>/_epi/raw/papers/<slug>/mineru/paper.md
...
<vault>/_epi/raw/papers/<slug>/run-state.json
```
...
```text
<vault>/_epi/raw/papers/<slug>/reader/reader.md
<vault>/_epi/raw/papers/<slug>/reader/editorial-summary.md
<vault>/_epi/raw/papers/<slug>/reader/technical-reading.md
<vault>/_epi/raw/papers/<slug>/reader/research-notes.md
<vault>/_epi/raw/papers/<slug>/reader/figures.md
<vault>/_epi/raw/papers/<slug>/reader/reproducibility.md
<vault>/_epi/raw/papers/<slug>/reader/implementation-ideas.md
<vault>/_epi/raw/papers/<slug>/reader/evidence-map.json
<vault>/_epi/raw/papers/<slug>/reader/claim-support.json
```
...
```text
<vault>/_epi/raw/papers/<slug>/critic/critic-report.json
<vault>/_epi/raw/papers/<slug>/critic/critic-quorum.json
<vault>/_epi/raw/papers/<slug>/critic/research-decision.json
<vault>/_epi/raw/papers/<slug>/critic/reader-revision-plan.json
<vault>/_epi/raw/papers/<slug>/critic/reproduction-plan.json
```
...
```text
<vault>/_epi/staging/papers/<slug>/references/<slug>.md
<vault>/_epi/staging/papers/<slug>/concepts/<slug>-concept.md
<vault>/_epi/staging/papers/<slug>/synthesis/<slug>-synthesis.md
<vault>/_epi/staging/papers/<slug>/reports/<slug>-reading-report.md
...
```text
<vault>/_epi/raw/papers/<slug>/wiki-ingest-record.json
<vault>/_epi/staging/papers/<slug>/wiki-ingest-record.json
<vault>/_epi/raw/papers/<slug>/zotero-record.json
```
...
3. `_epi/raw/papers/<slug>/metadata.json`
4. `_epi/raw/papers/<slug>/parse-record.json`
5. `_epi/raw/papers/<slug>/reader/claim-support.json`
6. `_epi/raw/papers/<slug>/critic/critic-quorum.json`
7. `_epi/staging/papers/<slug>/reports/<slug>-reading-report.md`
