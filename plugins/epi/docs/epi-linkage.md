...
page-family/frontmatter 的人读 canonical 是 PRW `plugins/PRW/rules/wiki-writing-standard.md`；EPI 文档只保留执行入口和最小索引，执行层常量仍在 `wiki_contracts.py` 中用于 gate 校验。
