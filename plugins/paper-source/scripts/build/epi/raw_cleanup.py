...
from epi.artifacts import epi_meta_root, raw_paper_root, raw_papers_root, staging_paper_root, utc_now, write_json_atomic
...
def _raw_cleanup_root(vault_path: Path) -> Path:
    return epi_meta_root(vault_path) / "raw-cleanup"
...
def cleanup_failed_raw_paper(
    ...
    *,
    ...
    record: dict[str, Any] = {
        "schema_version": "epi-raw-cleanup-v1",
        "slug": slug,
        "path": str(paper_root),
        "reason": reason,
