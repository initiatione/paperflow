...
FORMAL_PAGE_FAMILIES: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "purpose": "Separate author-claimed novelty from Paper Source-confirmed gaps and project ideas.",
    },
)
...
WIKI_DEPOSITION_QUALITY_GATES: dict[str, object] = {
    ...
    "internal_roots_forbidden_in_formal_graph": [
        "_paper_source",
        "_epi",
        "_raw",
        "_staging",
...
def qmd_collection_policy() -> dict[str, object]:
    return {
        ...
        "qmd_collection_contract": (
            ...
            "index.md, hot.md, log.md, and _meta/ contract pages; it must ignore _paper_source/**, "
            "legacy _epi/**, .obsidian/**, and .claude/**."
        ),
...
def final_source_review_must_record() -> list[str]:
    ...
    return [
        ...
        f"page_lifecycle with status {states}, allowed_states recorded exactly, and summary",
    ]
