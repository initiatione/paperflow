...
READER_EVIDENCE_MAP_SCHEMA_VERSION = "paper-source-reader-evidence-map-v1"
LEGACY_READER_EVIDENCE_MAP_SCHEMA_VERSION = "epi-reader-evidence-map-v1"
ACCEPTED_READER_EVIDENCE_MAP_SCHEMA_VERSIONS = {
    READER_EVIDENCE_MAP_SCHEMA_VERSION,
    LEGACY_READER_EVIDENCE_MAP_SCHEMA_VERSION,
}
CLAIM_SUPPORT_SCHEMA_VERSION = "paper-source-claim-support-v1"
LEGACY_CLAIM_SUPPORT_SCHEMA_VERSION = "epi-claim-support-v1"
ACCEPTED_CLAIM_SUPPORT_SCHEMA_VERSIONS = {
    CLAIM_SUPPORT_SCHEMA_VERSION,
    LEGACY_CLAIM_SUPPORT_SCHEMA_VERSION,
}
...
def validate_evidence_map(paper_root: Path) -> tuple[bool, list[str]]:
    ...
    if evidence_map.get("schema_version") not in ACCEPTED_READER_EVIDENCE_MAP_SCHEMA_VERSIONS:
...
def validate_claim_support_map(paper_root: Path, *, required: bool = False) -> tuple[bool, list[str]]:
    ...
    failures: list[str] = []
    if support_map.get("schema_version") not in ACCEPTED_CLAIM_SUPPORT_SCHEMA_VERSIONS:
