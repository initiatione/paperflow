...
def _decision_frontmatter_lines(decision: dict) -> list[str]:
    ...
    lines = [
        f"paper_source_recommendation: {_frontmatter_value(decision.get('recommendation', ''))}",
        f"paper_source_next_action: {_frontmatter_value(decision.get('next_action', ''))}",
        f"paper_source_panel_consensus: {_frontmatter_value(panel.get('consensus', ''))}",
        f"paper_source_blocking_lenses: {_frontmatter_value(panel.get('blocking_lenses') or [])}",
        f"paper_source_warning_reviewers: {_frontmatter_value(panel.get('warning_reviewers') or [])}",
    ]
