...
- `session_recommendations.no_primary_recommendations_summary` when primary recommendations are empty; explain whether DOI policy, required concept groups, quality gates, existing-library saturation, or recall/search gaps caused the empty primary list
