...
3. 发布本轮修复 commit，并从 GitHub/marketplace 重新安装 Paper Source/Paper Wiki，确认 installed cache 版本变为 Paper Source `1.0.4`、Paper Wiki `1.0.0`。
