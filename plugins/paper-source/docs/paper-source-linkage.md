...
- `quality_gate.dimensions`：identity、relevance、inspectability、validation、source_confidence、reproducibility、request_risk 七个通用维度；`relevance.basis` 必须说明 topic fit 来自 `priority_keywords` 还是 `positive_keywords_saturated`。
