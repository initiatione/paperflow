...
| Paper Wiki | `paper-wiki` | `1.0.6` | Ask, deposit, check, repair graph visibility, update, relink, redo, expose a Zotero helper adapter, and maintain formal paper wiki knowledge. |
