...
| Paper Wiki | `paper-wiki` | `1.2.0` | Ask, deposit, check, repair graph visibility, update, relink, redo, expose a Zotero helper adapter, provide Zotero data-contract foundations, run read-only Zotero status/dry-run previews, and maintain formal paper wiki knowledge. |
